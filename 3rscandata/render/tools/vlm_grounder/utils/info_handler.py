...
class SceneInfoHandler:
    ...
    def get_num_objects(self, scene_id):
        print("个数是多少, ", self.infos[scene_id]["num_objects"])
    ...
    def get_object_raw_category(self, scene_id, object_id, flag):
        print("scene_id ", scene_id)
        print("object_id", object_id)
        #print(self.infos[scene_id])
        #print(self.infos[scene_id][1])
        if flag:
            n2o = {}
            t = 0
            for jing in self.infos[scene_id].items():
                #print("每个item是啥", jing[0])
                n2o[t] = jing[0]
                t += 1
            print(n2o)
            idd = n2o[object_id]
            ...
            idd = object_id
        #print("object_id是啥, ", object_id)
        #print(self.infos[scene_id][object_id])
        #print(self.infos[scene_id][object_id]["raw_category"])
        return self.infos[scene_id][idd]["raw_category"]
    ...
    def get_scene_raw_categories(self, scene_id):
        ...
        flag = True
        return [
            self.get_object_raw_category(scene_id, object_id, flag)
