...
w = ['footstool', 'bathrobe', 'newspaper', 'hood', 'bathtub', 'furniture', 'can', 'fan', 'stair', 'cupboard', 'suitcase', 'frame', 'bottle', 'couch table', 'tire', 'lamp', 'shower', 'dispenser', 'brush', 'wall', 'pepper', 'bbq', 'bread', 'plant', 'paper towel', 'kettle', 'bucket', 'cradle', 'vacuum cleaner', 'basin', 'carpet', 'clutter', 'ceiling light', 'basket', 'hanger', 'refrigerator', 'sideboard', 'roof', 'vase', 'elevator', 'sofa chair', 'sofa', 'fire extinguisher', 'glass', 'pot', 'pile', 'washer', 'floor', 'plate', 'boiler', 'soap dispenser', 'bin', 'monitor', 'ceiling', 'heater', 'curtain', 'stuffed animal', 'towel', 'garbage', 'toilet brush', 'sidetable', 'organizer', 'spice', 'foosball table', 'light', 'chair', 'object', 'computer', 'container', 'box', 'tent', 'stroller', 'mandarins', 'kitchen towel', 'luggage', 'bike', 'ottoman', 'shades', 'dining table', 'tv', 'backpack', 'decoration', 'projector', 'mirror', 'cutting board', 'seat', 'washing powder', 'plank', 'rail', 'toilet', 'crate', 'squeezer', 'socket', 'folder', 'cleaning agent', 'ironing board', 'stereo', 'cup', 'player', 'washing machine', 'wardrobe', 'bed', 'sponge', 'commode', 'cube', 'seat pad', 'shampoo', 'ball', 'trash bin', 'scale', 'pillar', 'hair dryer', 'magazine', 'bag', 'rocking chair', 'balcony', 'stove', 'tree decoration', 'column', 'water heater', 'board', 'door', 'sheets', 'radiator', 'roll', 'scarf', 'book', 'console', 'stool', 'laundry basket', 'bookshelf', 'baby seat', 'counter', 'drink', 'umbrella', 'floor mat', 'water', 'fence', 'coffee maker', 'tube', 'cosmetics kit', 'hand brush', 'pc', 'toy', 'tv stand', 'shoe box', 'sink', 'dress', 'platform', 'pipe', 'rack', 'sidecouch', 'laptop', 'pack', 'mattress', 'picture', 'barrel', 'dish', 'soap', 'cycling trainer', 'food', 'wire', 'dumbbells', 'toilet paper holder', 'weights', 'trash can', 'sewing machine', 'shoe', 'pillow', 'stand', 'blinds', 'bench', 'flower', 'stick', 'cushion', 'office chair', 'cloth', 'notebook', 'bowl', 'keyboard', 'clothes dryer', 'mannequin', 'paper', 'showcase', 'fireplace', 'oven', 'microwave', 'piano', 'calendar', 'instrument', 'rowing machine', 'soap dish', 'office table', 'speaker', 'candle', 'screen', 'juicer', 'coat', 'tray', 'hand dryer', 'dish washer', 'toilet paper', 'ladder', 'machine', 'watering can', 'table', 'window', 'case', 'armchair', 'blanket', 'telephone', 'printer', 'washbasin', 'cart', 'shelf', 'clock', 'closet', 'cover', 'paper towel dispenser', 'dish dryer', 'toilet paper dispenser', 'storage', 'cabinet', 'air conditioner', 'aquarium']
...
if __name__ == "__main__":
    ...
    output_dir = "../../../ceshioutput360/image_instance_detectoryes"
    save_every_batches = (
        50  #  True: Store the results after each batch of data is completed
    )
    if DEBUG:
        output_dir = "../../../ceshioutput360/image_instance_detectoryes/debug"
        batch_size = 1
    ...
    info_file = "../../../ceshioutput360/3rscan_instance_data/scenes_train_val_info_w_images.pkl"
    print(f"[Running]: Processing csv file: {args.vg_file}.")
    print(f"[Running]: Using batch size {batch_size}.")

    dataset = ScanNetPosedImages(
        data_root="../../../ceshioutput360", info_file=info_file, scene_id_list=scene_to_process
    )
