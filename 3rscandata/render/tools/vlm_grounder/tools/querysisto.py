...
class QueryAnalysis:
    def __init__(
        ...
        self.global_cache_output_file_path = (
            f"../../../ceshioutput360/global_cacheto/query_analysis_v{prompt_version}/global_cache.json"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--vg_file",
        type=str,
        default="../../../ceshioutput360/zancun/today_250_updated2_relations.csv",
    )  # * no used
    ...
    prompt_version = 2
    output_dir = f"../../../ceshioutput360/query_analysis_v{prompt_version}to/"
    ...
    mmengine.mkdir_or_exist("../../../ceshioutput360/query_analysisto")
    new_vg_file_path = f"../../../ceshioutput360/query_analysisto/prompt_v{prompt_version}_updated_{os.path.basename(vg_file_path)}"
