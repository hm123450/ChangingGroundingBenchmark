...
class VisualGrounder:
    def __init__(
        ...
        self.yesvg_file_path = "../hm3rscandata/xuanran/ceshioutputscan/query_analysisyes/yesterday.csv"
    ...
    def eval(self):
        ...
        xiufu_FILE = "../hm3rscandata/xuanran/ceshioutputscan/query_analysisyes/yesterday.csv"
